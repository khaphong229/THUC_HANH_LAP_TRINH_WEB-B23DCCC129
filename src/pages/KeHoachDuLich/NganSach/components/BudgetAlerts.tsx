// src/pages/BudgetManagement/components/BudgetAlerts.tsx
...
const BudgetAlerts: React.FC = () => {
  ...
  // Lấy danh sách các danh mục vượt ngân sách
  const overBudgetCategories = getOverBudgetCategories();
  
  // Kiểm tra xem đã vượt ngân sách tổng chưa
  ...
  // Tính phần trăm chi tiêu của mỗi danh mục
  ...
  return (
    <div className="budget-alerts">
      ...
      {/* Danh sách các danh mục vượt ngân sách */}
      {overBudgetCategories.length > 0 ? (
        ...
        <Empty 
          description="Không có hạng mục nào vượt ngân sách" 
