...
const QuyetDinhTotNghiep: React.FC = () => {
  const { graduationDecisions, graduationBooks, addGraduationDecision, updateGraduationDecision, deleteGraduationDecision } = useModel('sovanbangtypes');
